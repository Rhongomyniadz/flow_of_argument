...
def main():
    ...
    ap.add_argument("--input", default="analysis_charts/clarification_prediction/questions.csv")
    ap.add_argument("--output", default="analysis_charts/clarification_prediction/questions_labeled.csv")
