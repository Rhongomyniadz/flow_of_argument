...
CONDITIONS_CSV="${CONDITIONS_CSV:-raw_history,raw_history_true_assumptions,raw_history_shuffled_assumptions,raw_history_stale_assumptions,raw_history_explicit}"
