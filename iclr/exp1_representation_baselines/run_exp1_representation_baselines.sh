...
CONDITIONS_CSV="${CONDITIONS_CSV:-raw_history,raw_history_true_assumptions,raw_history_different_episode_assumptions,raw_history_same_episode_random_turn_assumptions,raw_history_explicit}"
